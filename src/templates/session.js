...
const Session = ({ data }) => {
    ...
    return (
        <Layout sectionPadding='px-6'>
            <section>
                <div className="mx-6 session-mobile">
                    <div className="my-6 has-text-centered">
                        ...
                        <div className="level">
                            <NavButton navTo={prevSessionLink} navText="Prev" navDirection={BACK} className="level-item" size="is-size-3" />
                            <h1 className="level-item has-text-centered is-size-1 is-size-2-mobile">{name}</h1>
                            <NavButton navTo={nextSessionLink} navText="Next" navDirection={FWD} className="level-item" size="is-size-3" />
                        </div>
                    </div>
